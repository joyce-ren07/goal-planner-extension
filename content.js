...
(function () {
  ...
  function processGoalChips() {
    chrome.storage.local.get(['gp_chip_done'], async (data) => {
      ...
      const goals   = await getGoals();
      const SVG_CHECK = '<svg width="16" height="16" viewBox="0 0 20 20"><circle cx="10" cy="10" r="8" stroke="#C0514E" stroke-width="1.75" fill="none"/><polyline points="6,10 8.5,12.5 14,7.5" stroke="#C0514E" stroke-width="1.75" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>';
